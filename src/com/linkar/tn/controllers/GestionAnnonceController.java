...
public class GestionAnnonceController implements Initializable {
    ...
    TableView<Annonce> generateTable(List<Annonce> annonces){
       ...
       descriptionCol.setCellValueFactory(
                new PropertyValueFactory<Annonce, String>("description"));
   ...
   new Callback<TableColumn.CellDataFeatures<Annonce, String>, ObservableValue<String>>() {
      ...
      public ObservableValue<String> call(TableColumn.CellDataFeatures<Annonce, String> annonce) {
         ...
         property.setValue(dateFormat.format(java.sql.Date.valueOf( annonce.getValue().getDate_annonce() )));
         return property;
      }
   });
...
//init label
        ...
        Label l = generateLabel(membreService.getById(annonce.getId_membre()));
                    //set here
                     setGraphic(l);
                } else {
                  setGraphic(null);
...
buttonBlock.setOnAction(new EventHandler<ActionEvent>() {
                    @Override public void handle(ActionEvent event) {
                          ...
                          JFXButton d = new JFXButton("blocker");
               ...
               //  membreService.toggleMember(annonce.getM().getId_member(), false);
                 
               //  annonceService.removeAnnonce(annonce.getId_annonce());
                ...
                dialog.close();
                        ...
                        confirmDialog(d, "voulez vous vraiment blocker cet utilisateur ?", "confirmation");
...
buttonRemove.setOnAction(new EventHandler<ActionEvent>() {
               ...
               //  reclamationService.markReclamation(true, reclamation.getId_reclamation());
                 ...
                 //       refreshTable(reclamationService.getAllReclamation(false));
               JFXButton d = new JFXButton("supprimer");
               d.setOnAction(new EventHandler<ActionEvent>() {
                    @Override public void handle(ActionEvent event) {
               //  reclamationService.markReclamation(true, reclamation.getId_reclamation());
                ...
                annonceService.removeAnnonce(annonce.getId_annonce());
                table.getItems().remove(annonce);
                table.refresh();
                dialog.close();
                        System.err.println("deleting!!!");
                    }
                  });
                        confirmDialog(d, "voulez vous vraiment supprimer cette annonce?", "confirmation");
               /*
                 annonceService.removeAnnonce(annonce.getId_annonce());
                table.getItems().remove(annonce);
                table.refresh();
