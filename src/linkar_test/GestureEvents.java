...
public class GestureEvents extends Application {
 ...
 TableColumn<Person, Person> comboCol = new TableColumn<>("Gifts");
  
        comboCol.setMinWidth(150);
        comboCol.setCellValueFactory(new Callback<CellDataFeatures<Person, Person>, ObservableValue<Person>>() {
          @Override public ObservableValue<Person> call(CellDataFeatures<Person, Person> features) {
              return new ReadOnlyObjectWrapper(features.getValue());
          }
        });
        comboCol.setComparator(new Comparator<Person>() {
          @Override public int compare(Person p1, Person p2) {
            return p1.getLikes().compareTo(p2.getLikes());
          }
        });
       comboCol.setCellFactory(new Callback<TableColumn<Person, Person>, TableCell<Person, Person>>() {
...
final ComboBox comboBox = new ComboBox(options);
 ...
 ///////////////////////////////////////////////////////////
        ...
        table.setItems(data);
        table.getColumns().addAll(firstNameCol, lastNameCol, emailCol, btnCol,comboCol);
