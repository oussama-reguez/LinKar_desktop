...
public class Register2Controller implements Initializable {
    ...
    public void upload_picture(ActionEvent ae) throws Exception {
        ...
        String path = selectedFile_path.toString();
        /////changeurll;;;;;;
        String url = "http://localhost/" ;
        System.err.println(url);
        MembreIService s = new MembreServices();
        s.editImage(IDSession, url);
        picture.setImage(new Image(url));
        Parent login_page = FXMLLoader.load(getClass().getResource("/com/linkar/tn/gui/Register2.fxml"));
        Scene login_scene = new Scene(login_page);
        Stage app_stage = (Stage) ((Node) ae.getSource()).getScene().getWindow();
        app_stage.hide();
        app_stage.setScene(login_scene);
